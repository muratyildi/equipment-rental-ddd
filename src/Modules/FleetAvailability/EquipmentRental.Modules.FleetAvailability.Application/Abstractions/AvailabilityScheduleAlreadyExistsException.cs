...
public sealed class AvailabilityScheduleAlreadyExistsException(
    EquipmentCategoryId equipmentCategoryId,
    LocationId locationId)
    : Exception(
        $"An availability schedule already exists for category " +
        $"'{equipmentCategoryId}' at location '{locationId}'.")
{
